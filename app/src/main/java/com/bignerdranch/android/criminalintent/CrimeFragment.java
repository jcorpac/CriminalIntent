...
public class CrimeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if(mCrime.getSuspectPhoneNum() == null || mCrime.getSuspectPhoneNum() == "") {
    ...
    private void collectPhoneNumber() {
        ...
        Cursor c = getActivity().getContentResolver().query(contactUri, queryFields, selection, selectionArgs, null);
        try {
            if (c.getCount() == 0) {
                mCrime.setSuspectPhoneNum("");
                mCallButton.setEnabled(false);
                return;
            }
